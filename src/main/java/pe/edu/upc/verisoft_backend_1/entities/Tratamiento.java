...
public class Tratamiento {
    ...
    private LocalTime FechaTratamiento;
    ...
    public Tratamiento(int idTratamiento, String descripcionTratamiento, String estadoTratamiento, int presupuestoTratamiento, LocalTime fechaTratamiento, LocalTime fechaFinTratamiento, int horasTratamiento, String efectosEsperadosTratamiento, Oncologo oncologo) {
    ...
    public LocalTime getFechaTratamiento() {
        return FechaTratamiento;
    }

    public void setFechaTratamiento(LocalTime fechaTratamiento) {
        FechaTratamiento = fechaTratamiento;
    }
